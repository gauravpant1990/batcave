...
<head>
    ...
    <meta name="author" content="vincilabs">
	<?= Html::csrfMetaTags() ?>
    ...
    <section class="" id="people-speak">
        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                ...
                <div class="col-lg-6 col-sm-6">
                    <a class="portfolio-box">
						<p style = "background: url('img/portfolio/advertising-aspirant.png') no-repeat scroll 0 0 / 100px auto rgba(0, 0, 0, 0)">I was a little worried about pursuing my dream and creating a career out in Advertising would not be financially rewarding - Thanks to KDH. I came across entry level compensation with which I would be more than happy.</p>
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
